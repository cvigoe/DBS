function Storage = Parkinson_DBS_square_euler(k,b,h,step,t_final)
% This function solve a system of differential equations for a model of
% Parkinson's disease with DBS (2nd case) by Euler's method
...
for i = 1:length((t))
    ...
    % Calculate y_dot
    y_dot = -b*b*Storage(i,2) + square(2*pi*freq*Storage(i,1));
